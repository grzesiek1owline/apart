...
$flats
    ...
    ->addTrueFalse('flat-antresola', ['label' => 'Posiada Antresolę?', 'ui' => 1, 'default_value' => false ])
    ...
    ->addNumber('flat-price', ['label' => 'Cena mieszkania', 'instructions' => 'Pole aktualnie nie jest wykorzystywane na stronie.' ])
