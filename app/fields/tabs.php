...
$tabs
    ...
    ->addText('flat-list-hash-1', ['label' => 'Hash Tab 1', 'instructions' => 'Tylko małe litery', 'required' => 1])
    ->addText('flat-list-hash-2', ['label' => 'Hash Tab 2', 'instructions' => 'Tylko małe litery', 'required' => 1]);
return $tabs;
